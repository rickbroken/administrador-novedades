const frasesFamosas = [
  ...
  },
  {
	...
	{ autor: "Lao-Tsé", frase: "La travesía de mil millas comienza con un paso" },
    { autor: "Franklin D. Roosevelt", frase: "El único límite a nuestros logros de mañana está en nuestras dudas de hoy" },
    { autor: "Mahatma Gandi", frase: "Si quieres cambiar al mundo, cámbiate a ti mismo" },
    { autor: "Robert F. Kennedy", frase: "Solo aquellos que se atreven a tener grandes fracasos terminan consiguiendo grandes éxitos" },
    { autor: "Albert Einstein", frase: "Si quieres vivir una vida feliz, átala a una meta no a una persona u objeto" },
    { autor: "Gary Vaynerchuck", frase: "Por favor piensa en tu legado, porque lo estás escribiendo todos los días" },
    { autor: "Anónimo", frase: "Toma en serio tus sueños" },
    { autor: "Larry Ellison", frase: "El objetivo principal de una empresa es ganar dinero. La función primordial del Gobierno es tomar una gran parte de ese dinero y darla a los demás" },
    { autor: "Robert Kiyosaki", frase: "No es cuanto dinero ganas, sino cuando dinero ahorras, cuanto trabaja para ti y para cuantas generaciones tendrás" },
    { autor: "Rosa Nouchette Carey", frase: "Hazlo con pasión, o no lo hagas" },
    { autor: "Anónimo", frase: "La medida real de tu riqueza es cuando vales si pierdes todo tu dinero" },
    { autor: "Andrew Hendrixson", frase: "Todo aquel que haya hecho algo importante en la vida, fue disciplinado" },
    { autor: "John Lennon", frase: "La vida es lo que ocurre mientras estamos ocupados haciendo planes" },
    { autor: "Mary Kay Ash", frase: "Tenemos que tener una meta, un propósito en nuestras vidas. Si no sabes a donde estas apuntando, no tienes una meta" },
    { autor: "Anónimo", frase: "Algunas personas sueñan con el éxito, mientras otras se despiertan y trabajan para lograrlo" },
    { autor: "Steve Jobs", frase: "Las personas que están lo suficientemente locas como para pensar que pueden cambiar el mundo… son quienes lo cambian" },
    { autor: "Benjamin E. Mays", frase: "La tragedia en la vida no consiste en no alcanzar tus metas. La tragedia en la vida es no tener metas que alcanzar" },
    { autor: "William Feather", frase: "La riqueza fluye de la energía y de las ideas" },
    { autor: "Proverbio chino", frase: "El fracaso más grande es nunca haberlo intentado" },
    { autor: "Benjamin Franklin", frase: "Una inversión en conocimiento paga el mejor interés" },
    { autor: "Zig Ziglar", frase: "El pensamiento positivo te dejará hacer todo mejor que el negativo" },
    { autor: "Donald Trump", frase: "Si vas a pensar de todas formas, piensa en grande" },
		{
